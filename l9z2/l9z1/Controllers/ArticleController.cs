...
namespace l9z1.Controllers
{
    public class ArticleController : Controller
    {
        ...
        private IArticlesContextD _dataContext;

        // injection of IDataContext 
        public ArticleController(IArticlesContextD dataContext)
        {
        ...
        {
            return View(_dataContext.GetArticles().Values.ToList());// addded parameter
        }
